...
print(f"\n{valor:.2f} reais equivalem a {conversor.converter(valor, cotacao, 'real_para_dolar'):.2f} dólares.")
print(f"{valor:.2f} dólares equivalem a {conversor.converter(valor, cotacao, 'dolar_para_real'):.2f} reais.")
